...
class _ColorLoader2State extends State<ColorLoader2> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    actions: <Widget>[
      Container(
        child: IconButton(icon: Icon(Icons.card_giftcard), onPressed: (){ 
         showDialog(
    context: context,
    builder: (BuildContext context){
        return AlertDialog(
          ...
          title: Row(
          children:[
            Image.network('https://media1.giphy.com/media/APq0WQXgQQrKFcBbjP/200.gif',
              width: 200, height: 500, fit: BoxFit.contain,),
